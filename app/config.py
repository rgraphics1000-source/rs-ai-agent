...
class Settings:
    ...
    WHATSAPP_PHONE_NUMBER_ID: str = os.getenv("WHATSAPP_PHONE_NUMBER_ID", "418451428636680")
    KNOWN_RS_WA_PHONE_IDS: list = ["418451428636680", "418451426636680", "4184514263660680"]
