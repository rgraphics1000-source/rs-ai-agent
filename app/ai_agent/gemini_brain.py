...
def evaluate_id_card_workflow(
    ...
    # Case D1: Customer asks about price / discount / bargaining on a quoted or specific package (e.g., "এটা কত রাখা যাবে")
    is_asking_pkg_price_or_discount = any(k in msg for k in [
        "কত রাখা যাবে", "কত রাখবেন", "কত রাখবেন ভাই", "কত রাখা যায়", "কত রাখা যাই", "কত পরবে", "কত পড়বে", 
        "কত হবে", "দাম কত", "কত দাম", "রেট কত", "খরচ কত", "কম রাখা যাবে", "কম রাখা যাবে কি", "কম হবে", 
        "কম হবে কি", "কিছু কমানো যাবে", "কমানো যাবে", "ডিসকাউন্ট", "ছাড়", "কমাইয়া রাখেন", "কমিয়ে রাখেন", 
        "কম রাখা যায়", "একদাম কত", "লাস্ট প্রাইস", "সর্বনিম্ন কত", "ফিক্সড কত", "প্রাইস কত", "কত রাখা সম্ভভ", "কত রাখা সম্ভব"
    ])
    ...
    is_package_quoted_or_mentioned = any(k in msg for k in [
        ...
        any(k in msg for k in ["এটি", "এটা", "এইটা", "এই প্যাকেজ", "এই প্যাকেজটি", "এই প্যাকেজটা"])
    )
