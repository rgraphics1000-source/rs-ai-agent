...
def evaluate_id_card_workflow(
    ...
    has_phone_number_inquiry = any(k in msg for k in [
        "মোবাইল নম্বর", "মোবাইল নাম্বার", "ফোন নম্বর", "ফোন নাম্বার", "নাম্বার দিতে", "দিতে বলেছিলেন", 
        "এগুলো কেন", "দিচ্ছেন কেন", "whatsapp", "হোয়াটসঅ্যাপ"
    ]) and not any(k in msg for k in ["প্যাকেজ", "পেকেজ", "package", "pkg", "ছবি", "স্যাম্পল"])
    if has_phone_number_inquiry:
        return None
