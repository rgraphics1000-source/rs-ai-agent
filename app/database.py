...
def init_db():
    ...
    master_rules = [
        ...
        ("৩. স্যাম্পল ছবি ও প্যাকেজ পাঠানোর নির্দিষ্ট ক্রম", "কাস্টমার ৩০ বা তদূর্ধ্ব পিস বানাতে চাইলে (যেমন ৫০ পিস, ১০০ পিস) বা স্যাম্পল দেখতে চাইলে ক্রমানুসারে পাঠাতে হবে: ১) প্রথমে ১৫টি কার্ডের ছবি, কার্ড পাঠানো শেষে বলবে 'এগুলো আমাদের কার্ড, আমাদের তৈরি করা কার্ড।' ২) এরপর ৮টি ফিতার ছবি, সব ফিতা পাঠানো শেষে বলবে 'এগুলো আমাদের প্রিন্ট করা ফিতা।' ৩) এরপর ৮টি কভারের ছবি পাঠাবে। ৪) এরপর কাস্টমারের ট্রাস্টের জন্য ফেসবুক রিভিউ লিংক দেবে: 'আমাদের কাজের কোয়ালিটি ও কাস্টমারদের রিভিউ দেখতে আমাদের ফেসবুক পেজের এই পোস্টটি দেখতে পারেন: https://www.facebook.com/share/p/19Agfhw4gv/' ৫) এরপর আমাদের প্যাকেজের ৭টি ছবি পাঠাবে।", "instruction", "ছবি দেখান", "Sales Protocol", 1),
        ...
        ("১৩. ইউভি প্রিন্ট কোয়ালিটি", "আমরা জাপানি মেশিনের অরজিনাল UV কালার প্রিন্ট করি, যা ১০০% ওয়াটারপ্রুফ, প্রিমিয়াম ফিনিশিং এবং দীর্ঘস্থায়ী।", "qa", "কোয়ালিটি কেমন?", "Product Quality", 1),
        ("১৪. ক্রয়মূল্য গোপন রাখা", "কাস্টমারকে কখনো আমাদের নিজস্ব উৎপাদন বা ক্রয়মূল্য বলা যাবে না। সর্বদা নির্ধারিত বিক্রয়মূল্য বলতে হবে।", "instruction", "", "Business Policy", 1),
        ("১৫. হিউম্যান টেকওভার ও এআই নিস্তব্ধতা", "বিজনেস ওনার বা এজেন্ট চ্যাটে কথা বলা শুরু করলে এআই সম্পূর্ণ নীরব থাকবে এবং কোনো স্বয়ংক্রিয় উত্তর দেবে না।", "instruction", "", "System Protocol", 1),
        ("১৬. ভদ্রতা, সংক্ষিপ্ততা ও সম্বোধন", "কাস্টমার পুরুষ হলে 'স্যার' এবং মহিলা হলে 'ম্যাম' সম্বোধন করবে। কখনোই 'ভাইয়া' বা 'আপু' বলবে না। সংক্ষিপ্ত ও টু-দ্য-পয়েন্ট উত্তর দেবে।", "instruction", "", "Tone & Etiquette", 1),
        ("১৭. অজানা বিষয়ের উত্তর বানিয়ে না বলা", "যে তথ্য জানা নেই সে বিষয়ে বানিয়ে কোনো উত্তর দেবে না। বলবে: 'জি স্যার/ম্যাম, এই বিষয়টি জেনে আমাদের টিম আপনাকে খুব দ্রুত জানাচ্ছে।'", "instruction", "", "Anti-Hallucination", 1),
        ("১৮. পারসিস্টেন্ট মিডিয়া অপশন (ভয়েস ও ভিডিও)", "সিস্টেমে সংরক্ষিত ভিডিও ও ভয়েস ক্লিপ স্থায়ীভাবে সংরক্ষিত থাকবে এবং ফাংশন বা রিলোডে হারিয়ে যাবে না। কাস্টমার চাইলে সংশ্লিষ্ট ভিডিও বা ভয়েস পাঠাবে।", "instruction", "", "Media", 1)
    ]
